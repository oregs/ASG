...
$q_submission = $db->query("SELECT a.assignment_id, a.course_code, a.submission_date, a.ass_details, a.format FROM assignmentsubmission a, courseassign e, course c WHERE a.course_code=c.courseCode AND a.student_id=$student_id AND e.course=c.courseID ORDER BY a.course_code");
?>
<!DOCTYPE html>
