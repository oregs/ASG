					...
					<div id = "score_table">
						<table id = "table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php 
									$q_result = $db->query("SELECT *, sum(ifnull(Assignment_1, 0) + ifnull(Assignment_2, 0) + ifnull(Assignment_3, 0) + ifnull(Assignment_4, 0) + ifnull(Assignment_5, 0)) as total FROM assignmentresult  GROUP BY id");
